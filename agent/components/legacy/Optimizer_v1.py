...
from agent.components.RASK import calculate_missing_vars, get_dependent_variable_mapping
from agent.components.RASK import RASK
from agent.components.legacy.SLORegistry_v1 import calculate_SLO_F_clients
...
def local_obj(x, service_type: ServiceType, parameter_bounds, slos_all_clients, total_rps, rask: RASK):
    ...
    dependent_variables = get_dependent_variable_mapping(service_type)
